(function () {
  ...
  const ANNOYANCE_ATTRIBUTES = {
    ...
    chatInputNotices: 'data-twitch-enhancer-block-chat-input-notices',
    ...
    fallback.modules.blockAnnoyances = {
      ...
      goAdFreeButton:
        typeof blockAnnoyances.goAdFreeButton === 'boolean'
          ...
          : true,
      footer:
        typeof blockAnnoyances.footer === 'boolean' ? blockAnnoyances.footer : true,
      storiesLeftPanel:
      ...
      stickyCommunityHighlight:
        typeof blockAnnoyances.stickyCommunityHighlight === 'boolean'
          ...
          : true,
      chatInputNotices:
        typeof blockAnnoyances.chatInputNotices === 'boolean'
          ? blockAnnoyances.chatInputNotices
          : false,
      chatBitsBalance:
